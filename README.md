...
| Yes         | SMALLINT   | SQL\_C\_SHORT          | 2-byte signed integer                       | -32,768                       | 32,767                        |
| Yes         | INTEGER    | SQL\_C\_LONG           | 4-byte signed integer                       | -2,147,483,648                | 2,147,483,647                 |
| Yes         | BIGINT     | SQL\_C\_SBIGINT        | 8-byte signed integer                       | -9,223,372,036,854,775,808    | 9,223,372,036,854,775,807     |
| Yes         | FLOAT      | SQL\_C\_DOUBLE         | Double-precision floating point             | ~±2.23E-308                   | ~±1.79E+308                   |
| Yes         | REAL       | SQL\_C\_FLOAT          | Single-precision floating point             | ~±1.18E-38                    | ~±3.40E+38                    |
| Yes         | DOUBLE     | SQL\_C\_DOUBLE         | Double-precision floating point             | ~±2.23E-308                   | ~±1.79E+308                   |
...
| Yes               | SQLFetchScroll          | Fetches a row from a result set based on a specific orientation (scrollable cursors).                  |
| No                | SQLForeignKeys          | Information about foreign keys in tables.                                                              |
| Yes               | SQLFreeHandle           | Releases resources for handles allocated using SQLAllocHandle.                                         |
| NA                | SQLFreeStmt             | Releases statement resources or closes active cursors for a statement.                                 |
...
| Yes               | SQLGetData              | Retrieves data for a single column, useful for long data values.                                       |
...
| Yes               | SQLGetDiagRec           | Gets detailed diagnostic records.                                                                      |
| Yes               | SQLGetEnvAttr           | Retrieves the value of an environment attribute.                                                       |
...
| Yes               | SQLSetConnectAttr       | Sets a connection attribute.                                                                           |
